<template>
  <div class="OutStationOutside">
    <van-cell-group>
      ...
      <!--  -->
      <van-field v-model="secondName" required label="第二联系人姓名" placeholder="请输入"/>
      <van-field v-model="secondCompany" required label="第二联系人工作单位" placeholder="请输入"/>
      <van-field v-model="secondPhone" required label="第二联系人工作单位电话" placeholder="请输入"/>
      <van-field v-model="secondAddr" required label="第二联系人住址或单位" placeholder="请输入"/>
...
.OutStationOutside .van-field__control{
